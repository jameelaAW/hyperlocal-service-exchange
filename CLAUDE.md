# hyperlocal-service-exchange

A personal neighborhood skill-and-stuff exchange board where the owner publishes repair offers, giveaways, and community help requests — viewable by anyone, fully controlled by the owner.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "299811736+jameelaAW@users.noreply.github.com"
  git config user.name "jameelaAW"
  ```
